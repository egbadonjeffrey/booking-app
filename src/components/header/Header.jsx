        ...
        {type !== "list" && (
          <>
            ...
            <p className="headerDescription">
              ...
              pariatur architecto optio omnis placeat at minima voluptatibus
              porro alias magnam voluptate perspiciatis fuga eveniet sapiente
              consequatur
            </p>
            ...
            <div className="headerSearch">
              <div className="headerSearchItem">
                ...
                <input
                  type="text"
                  placeholder="Where would you like to going?"
